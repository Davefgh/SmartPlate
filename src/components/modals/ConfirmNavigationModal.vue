        ...
        <div class="flex items-center justify-center min-h-screen p-4 text-center sm:p-0">
          ...
          >
                ...
                <div class="mt-4 text-center sm:mt-0 sm:ml-6 sm:text-left">
                  ...
                  <div class="mt-2">
                    <p class="text-base text-gray-500">
                      Your form progress will be saved, and you can continue later from the
                      dashboard.
                    </p>
                  </div>
                </div>
            ...
            <div class="bg-gray-50 px-6 py-4 sm:px-8 sm:flex sm:flex-row-reverse gap-3">
              <button
                type="button"
                class="w-full inline-flex justify-center items-center rounded-lg border border-transparent px-5 py-2.5 bg-dark-blue text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 sm:w-auto"
                @click="handleConfirm"
              >
                Save & Return
              </button>
