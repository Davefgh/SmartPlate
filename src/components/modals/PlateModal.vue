        ...
        <div class="flex flex-col md:flex-row">
          ...
          >
            <div class="flex flex-col items-center justify-center py-12">
              ...
              <div class="bg-white border-4 border-gray-800 rounded-lg p-4 mb-6 shadow-lg w-48 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div class="bg-gray-50 p-3 rounded-lg">
                ...
                <div class="flex items-center">
                  ...
                  <span class="text-base font-medium">{{ plate.vehicleMake }} {{ plate.vehicleModel }}</span>
                </div>
              </div>
              ...
              <div class="bg-gray-50 p-3 rounded-lg">
                ...
                <div class="flex items-center">
                  <font-awesome-icon :icon="['fas', 'calendar-check']" class="text-dark-blue mr-2" />
              ...
              <div class="bg-gray-50 p-3 rounded-lg">
                ...
                <div class="flex items-center">
                  <font-awesome-icon :icon="['fas', 'calendar-times']" class="text-dark-blue mr-2" />
              ...
              <div class="space-y-4">
                <div class="flex items-start">
                  ...
                  <div class="ml-3">
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">The standard renewal fee is $75.00 for private vehicles.</p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3">
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">Vehicle registration, proof of insurance, and valid ID.</p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3">
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">You can renew online or visit any DMV office with your documents.</p>
                  </div>
                </div>
              </div>
            </div>
